...
<script src="{{ URL::asset('dashboard/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
...
<!-- AdminLTE App -->
<script src="{{ URL::asset('dashboard/js/adminlte.js') }}"></script>
